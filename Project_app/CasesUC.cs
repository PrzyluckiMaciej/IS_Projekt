...
namespace Project_app
{
    public partial class CasesUC : UserControl
    {
        ...
        private void export_Click(object sender, EventArgs e)
        {
            ...
            string selectedFormat = ChoiceExportCases.SelectedItem.ToString();
            ...
            if (selectedFormat == "JSON")
            {
                ...
                saveFileDialog.FileName = $"JSON_export_{when}_cases_{timestamp}.json";
            ...
            else if (selectedFormat == "XML")
            {
                ...
                saveFileDialog.FileName = $"XML_export_{when}_cases_{timestamp}.xml";
            ...
            else if (selectedFormat == "YAML")
            {
                ...
                saveFileDialog.FileName = $"YAML_export_{when}_cases_{timestamp}.yaml";
